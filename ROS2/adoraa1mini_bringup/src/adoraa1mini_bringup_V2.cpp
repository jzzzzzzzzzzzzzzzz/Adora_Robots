...
public:
    ...
    {
        // 参数声明和获取
		declare_parameter<std::string>("usart_port",usart_port);
		declare_parameter<int>("baud_data",baud_data);
		declare_parameter<double>("control_mode", control_mode);
        ...
        dt_error_sub = this->create_subscription<std_msgs::msg::UInt8::SharedPtr>("/collision_release", 
        ...
        pub1 = this->create_publisher<adoraa1mini_bringup::msg::Dt1>("/DT_Robot_agv1",20); 

        dt_control_sub = this->create_subscription<geometry_msgs::msg::Twist::SharedPtr >("/cmd_vel",
                            10,std::bind(&ADoraA1MiniNode::dt_control_callback,this,std::placeholders::_1));
    

        pub2 = this->create_publisher<adoraa1mini_bringup::msg::Dt2>("DT_Robot_agv2",20); 
...
private:
	...
	rclcpp::Subscription<std_msgs::msg::UInt8::SharedPtr>::SharedPtr dt_error_sub;
    ...
    rclcpp::Subscription<geometry_msgs::msg::Twist::SharedPtr >::SharedPtr dt_control_sub;
